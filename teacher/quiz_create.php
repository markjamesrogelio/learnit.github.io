        ...
        if ($title === '') {
            ...
            if ($stmt->execute()) {
                ...
                foreach ($section_names as $section_name) {
                    ...
                    $stmt->bind_param("ssss", $quiz_id, $course_name, $year_level, $section_name);
                    $stmt->execute();
                }
...
<div class="container">
    <header class="page-header">
        <h2>Create Quiz</h2>
        <p>Design quick assessments, assign sections, and engage students effectively</p>
    </header>
    ...
    <?php if ($quiz_id): ?>
        ...
        <form method="post" action="quiz_create.php?quiz_id=<?= $quiz_id ?>">
            ...
            <div id="options_fields" class="hidden">
            ...
            <a href="dashboard.php?section=quiz" class="btn btn-cancel">Finish</a>
        </form>
            ...
            <ul class="questions-list">
                <?php foreach ($questions as $q): ?>
                    <li>
                        ...
                        <a href="quiz_edit_question.php?id=<?= $q['id'] ?>&quiz_id=<?= $quiz_id ?>" style="color:#007bff;">Edit</a> |
                        <a href="quiz_create.php?action=delete_question&id=<?= $q['id'] ?>&quiz_id=<?= $quiz_id ?>" onclick="return confirm('Delete this question?');" style="color:#dc3545;">Delete</a>
                    </li>
                <?php endforeach; ?>
            </ul>
        <?php endif; ?>
